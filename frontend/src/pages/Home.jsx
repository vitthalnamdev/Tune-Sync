...
{/* 
      ...
      <main className="container mx-auto px-4 pb-24">
        ...
        <section className="my-8 rounded-xl overflow-hidden">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
              ...
              create the perfect playlist for every moment.
            </p>
        ...
        <section className="my-12 relative">
          ...
          <span
            className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-3xl cursor-pointer hover:text-white transition-colors"
